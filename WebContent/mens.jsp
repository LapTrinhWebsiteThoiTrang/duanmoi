	...
	<div class="col-md-3 product-men">
		<div class="men-pro-item simpleCart_shelfItem">
			<div class="men-thumb-item">
				<img src="public/images/<%="khoac_men/khoac_men"+ Integer.toString(i)%>.jpg" alt="" class="pro-image-front">
				<img src="public/images/<%="khoac_men/khoac_men"+ Integer.toString(i)%>.jpg" alt="" class="pro-image-back">
