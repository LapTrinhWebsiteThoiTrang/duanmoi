...
<div class="header" id="home">
		<div class="container">
			<ul>
				...
				<li><i class="fa fa-phone" aria-hidden="true"></i> Call : 0387661655</li>
				<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="vophuocson.1998@gmail.com">vophuocson.1998@gmail.com</a></li>
			</ul>
		</div>
	</div>
	<!-- //header -->
		...
		<div class="header-bot_inner_wthreeinfo_header_mid">
			...
			<!-- header-bot -->
				<div class="col-md-4 logo_agile">
					<h1><a href="index.html"><span>V</span>nshop.com <i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
				</div>
	        <!-- header-bot -->
				  ...
				  <div class="container-fluid">
					...
					<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
					  <ul class="nav navbar-nav menu__list">
						...
						<li class="dropdown menu__item">
							<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Children  <span class="caret"></span></a>
								<ul class="dropdown-menu multi-column columns-3">
									<div class="agile_inner_drop_nav_info">
										<div class="col-sm-3 multi-gd-img">
											<ul class="multi-column-dropdown">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<div class="col-md-4 modal_body_right modal_body_right1">
						<img src="publicimages/log_pic.jpg" alt=" "/>
					</div>
					<div class="clearfix"></div>
				</div>
			</div>
