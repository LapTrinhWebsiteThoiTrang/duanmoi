    ...
    <div class="khungTong">
        <div class="khung">
            <div class="positionMenu" class="list-group">
                <a href="Quan_li_san_pham.jsp" class="list-group-item list-group-item-action list-group-item-secondary">Quản lí sản phẩm</a>
                <a href="Quan_li_nguoi_dung.jsp" class="list-group-item list-group-item-action list-group-item-secondary">Quản lí người dùng</a>
        ...
        <div class="khungHienThi">
            ...
            <div class="thongtinchung">
                <div class="thongtin__infor">
                    <div class="thongtinchung__img">
                        <img src="image/NÃ³n bÃ© trai/nbt1.jpg" alt="">
                    </div>
                    <ul>
            ...
            <div class="chonlua">
                <a href="#">Các sản phẩm đã mua</a>
                <a href="#">Các sản phẩm đã xem</a>
                <a href="#"> Giỏ hàng</a>
            </div>
            <div class="spdaxem">
                <div class="spdaxem__item">
                    <div class="spdaxem__img">
                        <img src="image/Quáº§n jean bÃ© gÃ¡i/qjbg10.jpg" alt="">
                    </div>
